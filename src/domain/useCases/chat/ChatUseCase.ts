...
export class ChatUseCase {
  ...
  async obtenerUsuariosDisponibles(): Promise<Array<{ id: string; email: string; rol: string }>> {
    try {
      ...
      // Si es asesor, obtener todos los usuarios registrados
      // Si es usuario, obtener todos los asesores
      const rolBuscado = usuarioActual.rol === "asesor_comercial" ? "usuario_registrado" : "asesor_comercial";
